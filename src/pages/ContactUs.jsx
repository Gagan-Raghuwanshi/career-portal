...
function ContactUs() {
    ...
    return (
        ...
        //     <img
        //       src="https://actestlab.com/wp-content/uploads/2017/03/contact-us-1000x222.jpg"
        //       className="h-52 w-full"
        //     />
        //     <span className="-mt-12 text-white font-bold text-5xl">Contact Us</span>
        //   </div>
        //   <div className="flex justify-between px-72">
        //     <div className="mt-8">
        //       <div className="flex flex-col gap-2">
        //         <h6 className="text-4xl">Contact Details</h6>
        //         <p className="text-xl">
        //           Looking to contact us? Pick the option that fits your inquiry
        //           best!
        //         </p>
        //       </div>
        //       {/* <div className="">
        ...
        //             type="text"
        //             placeholder="Name*"
        //             className="outline-none text-xl border-b-2 border-gray-400 w-72"
        //           />
        //           <input
        //             type="text"
        //             placeholder="Phone*"
        ...
        //             type="text"
        //             placeholder="Message*"
        //             className="w-full outline-none text-xl border-gray-400 border-b-2"
        //           />
        //         </div>
        //         <div className="flex justify-end mr-4 mt-3">
        //           <button className="py-2 px-6 font-bold text-white bg-yellow-600 hover:bg-yellow-700 rounded-full">
        //             Submit
        //           </button>
        //         </div>
        //       </div>
                    ...
                    <div className="bg-[#011c2b] rounded-lg p-6 h-full max-lg:order-1">
                        ...
                        <ul className="mt-16 space-y-8">
                            <li className="flex items-center">
                                ...
                                <Link className="text-white text-sm lg:text-gray-500 ml-4">
                                    contact@royalswebtechpvtltd.com
                                </Link>
                            </li>
                            <li className="flex items-center ">
                                <svg
                                ...
                                <div className="flex flex-col text-white text-sm lg:text-gray-500 ml-4 mt-4">
                                    <Link>
                                        Management: 8788447944
                                    </Link>
                                    <div className=" ">
                                        HR Department: 7276081626 /{" "}
                                        <span className="ml-[105px]">8983071626</span>
                                    </div>
                                </div>
                            </li>
                            ...
                            <li className="flex items-center">
                                ...
                                <Link className="text-white text-sm lg:text-gray-500 ml-4">
                                    JB Wing, 4th Floor, Mangalwari Complex, Sadar, Nagpur-01
                                </Link>
                            </li>
                        </ul>
                            ...
                            <div className="grid sm:grid-cols-2 gap-8">
                                ...
                                <div className="relative flex items-center">
                                    <input
                                        ...
                                        value={data.Phone}
                                        onChange={handleonchange}
                                        className="px-2 py-3 bg-white text-black w-full text-sm lg:text-gray-800 border-b border-gray-300 focus:border-blue-500 outline-none"
                                    />
                                    <svg
                                        fill="#bbb"
                                        className="w-[18px] h-[18px] absolute right-2"
                                ...
                                <div className="relative flex items-center sm:col-span-2">
                                    <textarea
                                        ...
                                        value={data.Message}
                                        onChange={handleonchange}
                                        className="px-2 pt-3 bg-white text-black w-full text-sm lg:text-gray-800 border-b border-gray-300 focus:border-blue-500 outline-none"
                                    ></textarea>
                                    <svg
                                        xmlns="http://www.w3.org/2000/svg"
                                        fill="#bbb"
                                    ...
                                    <div className="flex max-lg:flex-col gap-6 mt-4">
                                        ...
                                        <div className="flex items-center">
                                            <input
                                                ...
                                                onChange={handleonchange}
                                                className="hidden peer"
                                                checked={data.Subject === "Website Feedback"}
                                            />
                                            <label
                                                htmlFor="radio3"
                                                className="relative p-0.5 flex items-center justify-center shrink-0 peer-checked:before:hidden before:block before:absolute before:w-full before:h-full before:bg-white w-5 h-5 cursor-pointer border-2 border-[#011c2b] rounded-full overflow-hidden"
